...
The plots have been created using wandb during the hyperparameter sweep. [W&B Plots](https://wandb.ai/cs23b069-iit-madras-/CS6886_Assignment2/reports/CS6886-Assignment-2-Plots--VmlldzoxNzg4MDgxOA) can be viewed here. 

## Running in Kaggle Notebook
The kaggle notebook has pre-loaded dataset and all the files in the repository are present in the notebook environment (in their latest version). 

The kaggle notebook also has the commands and cells to run the training and inference pipelines.
...
The repository files use `wandb` commands to plot interactive graphs and do hyperparameter sweeps. While running locally, ensure to do `wandb login` to login before running the files.
